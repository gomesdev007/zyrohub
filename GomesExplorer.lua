...
Main.BackgroundColor3 = Color3.fromRGB(42,42,45)
...
Search.BackgroundColor3 = Color3.fromRGB(52,52,56)
...
local function makeSmallButton(parent,text,x,w)
    ...
    b.BackgroundColor3 = Color3.fromRGB(58,58,62)
    b.BorderSizePixel = 0
    b.Text = text
...
Legend.Size = UDim2.new(1,-24,0,18)
Legend.Position = UDim2.new(0,12,0,187)
Legend.BackgroundTransparency = 1
Legend.Text = "▶ fechado   ▼ aberto   • sem filhos"
Legend.TextColor3 = Color3.fromRGB(145,145,150)
Legend.TextSize = 9
...
Results.Size = UDim2.new(1,-24,1,-216)
Results.Position = UDim2.new(0,12,0,208)
Results.BackgroundColor3 = Color3.fromRGB(38,38,41)
    ...
    for _, child in ipairs(Results:GetChildren()) do
        if child:IsA("TextButton") then
            ...
            if ref and ref == objectPath(obj) then
                ...
                child.BackgroundColor3 = Color3.fromRGB(48,48,52)
            end
        end
    end
end
...
local function makeTreeButton(obj,depth)
    ...
    button.BackgroundColor3 = Color3.fromRGB(48,48,52)
    ...
    local prefix = hasChildren and (expanded[obj] and "▼ " or "▶ ") or "  "
    local kindIcon = iconFor(obj)

    label.Text = prefix .. kindIcon .. "  " .. obj.Name .. "  <" .. obj.ClassName .. ">"
    label.Parent = button
...
local function buildInfo(obj)
    ...
    InfoFrame.BackgroundColor3 = Color3.fromRGB(42,42,45)
    ...
    copy.BackgroundColor3 = Color3.fromRGB(55,55,59)
