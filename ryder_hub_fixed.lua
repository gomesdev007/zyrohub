...
local function createCard(y, name, initialStatus)
    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        elseif name == "Instant Prompt" then
            ...
            -- Instant Prompt = mantém o prompt habilitado e zera o HoldDuration.
...
--==================================================
-- AUTO SLAP TP SELECTOR
--==================================================

local slapTPCard = Instance.new("Frame")
slapTPCard.Position = UDim2.fromOffset(16,358)
...
slapTPCorner.CornerRadius = UDim.new(0,12)
slapTPCorner.Parent = slapTPCard

local slapTPStroke = Instance.new("UIStroke")
slapTPStroke.Color = Color3.fromRGB(34,34,38)
slapTPStroke.Thickness = 1
slapTPStroke.Parent = slapTPCard
...
slapTPStatus.Text = selectedTargetPlayer and selectedTargetPlayer.Name or "select target"
...
slapTPButton.AnchorPoint = Vector2.new(1,.5)
slapTPButton.Position = UDim2.new(1,-12,.5,0)
slapTPButton.Size = UDim2.fromOffset(34,18)
slapTPButton.BackgroundColor3 = Color3.fromRGB(30,30,34)
slapTPButton.BorderSizePixel = 0
slapTPButton.Text = ">"
slapTPButton.Font = Enum.Font.GothamBold
slapTPButton.TextSize = 12
slapTPButton.TextColor3 = Color3.fromRGB(190,190,195)
slapTPButton.AutoButtonColor = false
slapTPButton.Parent = slapTPCard

local slapTPButtonCorner = Instance.new("UICorner")
slapTPButtonCorner.CornerRadius = UDim.new(1,0)
slapTPButtonCorner.Parent = slapTPButton

local slapTPButtonStroke = Instance.new("UIStroke")
slapTPButtonStroke.Color = Color3.fromRGB(52,52,57)
slapTPButtonStroke.Thickness = 1
slapTPButtonStroke.Parent = slapTPButton

slapTPCard.InputBegan:Connect(function(input)
    if input.UserInputType == Enum.UserInputType.MouseButton1
    or input.UserInputType == Enum.UserInputType.Touch then
        showPlayerList()
    end
...
footer.Position = UDim2.fromOffset(15,420)
...
local function updateInstantPrompts()
    if not instantPromptEnabled then
        return
    end
...
-- Prompts criados depois também ficam instantâneos.
ProximityPromptService.PromptShown:Connect(function(prompt)
    if instantPromptEnabled and prompt then
        prompt.HoldDuration = 0
        prompt.Enabled = true
    end
end)
