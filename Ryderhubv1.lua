...
floatButton.Image = "rbxassetid://138175358452197"
...
-- Use the supplied asset as the primary image; fallback to the previous working ID.
task.spawn(function()
    task.wait(2)
    if floatButton.Image == "" then
        floatButton.Image = "rbxassetid://71571085068909"
    end
end)
