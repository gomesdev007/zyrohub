    ...
    toggle.MouseButton1Click:Connect(function()
        ...
        elseif name == "Auto Slap TP" then
            ...
            if not enabled then
                ...
                slapTPStatus.Text = "None"
            else
                -- Abre a lista de players quando ativa
...
createSlider(312,"Speed",selectedSpeed,function(value)
    selectedSpeed = value
end)
...
--==================================================
-- AUTO SLAP TP TARGET DISPLAY
--==================================================

local slapTPStatus = Instance.new("TextLabel")
slapTPStatus.BackgroundTransparency = 1
slapTPStatus.Position = UDim2.new(1,-58,0,197)
slapTPStatus.Size = UDim2.fromOffset(39,14)
