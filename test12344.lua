...
aM=function(...) h.alive=false pcall(setInstantPickup,false) pcall(setBatAura,false) pcall(setAntiTrap,false) pcall(setAntiRagdoll,false) pcall(function() if h.stealCounterGui then h.stealCounterGui:Destroy() end end) pcall(Ik)pcall(Ak)pcall(function() y:Set3dRenderingEnabled(true) end)pcall(D4)pcall(u4)
