...
Q4=function(e,r,...)
    ...
    while h.alive and(h.isReturning and os.clock ()<s)do
        ...
        if not h.pureTweenFarm and not h.autoFarmLoop and not h.manualStealReturn then
...
local function returnToSafeAreaManual(source)
    ...
    if h.isReturning or h.glidingToTarget or h.teleporting or h.delivering then return false end
    ...
    local ok=pcall(function()
        Q4(h.glideSpeed,"MANUAL_SAFE")
    end)
    if not ok then h.isReturning=false end
    return ok
end
