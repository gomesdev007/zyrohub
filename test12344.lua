...
local function oM(...)
    ...
    local FarmTab=Window:AddTab({Title="Auto Farm",Icon="box"})
    hk=FarmTab
    Fk.secModes=FarmTab:AddSection("Auto Steal")

    local updating=false
    local teleportToggle=FarmTab:AddToggle("AutoStealTeleport",{
    ...
    Fk.secEggZones=FarmTab:AddSection("Target Zones")
    local zoneValues={
    ...
    local zoneDropdown=FarmTab:AddDropdown("SelectedZones",{
    ...
    Fk.secEggRarity=FarmTab:AddSection("Target Rarities")
    local rarityValues={
    ...
    local rarityDropdown=FarmTab:AddDropdown("SelectedRarities",{
    ...
    local secretToggle=FarmTab:AddToggle("AlwaysSecretPlus",{
    ...
    Fk.secFlight=FarmTab:AddSection("Farm Settings")
    local speedSlider=FarmTab:AddSlider("FlightSpeed",{
        Title="Flight Speed",
