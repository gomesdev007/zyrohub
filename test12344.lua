...
aM=function(...) h.alive=false pcall(Ik)pcall(Ak)pcall(function() y:Set3dRenderingEnabled(true) end)pcall(D4)pcall(u4)
...
local function oM(...)
    ...
    task.wait()
    updateLoading(86,"loading settings")
...
o.CharacterAdded:Connect(function(character)
    task.wait(0.6)
    if h.alive then
        D4();n4();C4();A4();b4(false);z4(character);u4()
    end
end)
