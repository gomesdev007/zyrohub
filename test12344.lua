...
local function oM(...)
    ...
    if not WindUI then
        pcall(function()
            WindUI=(loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Footagesus/WindUI/main/dist/main.lua")))()
        end)
    end
    if not WindUI then
    ...
    FarmTab:Section({Title="Auto Steal",Box=false})

    local updating=false
    local teleportToggle=FarmTab:Toggle({
    ...
    FarmTab:Space()
    FarmTab:Section({Title="Target Zones",Box=false})
    local zoneValues={
    ...
    FarmTab:Space()
    FarmTab:Section({Title="Target Rarities",Box=false})
    local rarityValues={
    ...
    FarmTab:Space()
    local secretToggle=FarmTab:Toggle({
    ...
    FarmTab:Space()
    FarmTab:Section({Title="Farm Settings",Box=false})
