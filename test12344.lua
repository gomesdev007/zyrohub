...
startupStep(12,"preparing player state",function()
    pcall(function() D4() end)
end)
startupStep(18,"preparing egg scanner",function()
    pcall(function() ek() end)
end)
startupStep(25,"preparing target cache",function()
    pcall(function() x() end)
end)
startupStep(32,"preparing character controller",function()
    pcall(function() C4() end)
end)
startupStep(40,"preparing humanoid system",function()
    pcall(function() A4() end)
end)
startupStep(48,"preparing movement system",function()
    if o.Character then pcall(z4,o.Character) end
end)
startupStep(56,"preparing protection",function()
    pcall(function() b4(true) end)
end)
startupStep(64,"preparing status system",function()
    pcall(function() u4() end)
end)
startupStep(72,"preparing auto steal systems",function()
    -- Controllers are already defined; keep them idle until the final gate.
    pcall(function() Y4="NONE" end)
end)
startupStep(80,"preparing automation",function()
    -- Automation loops remain parked behind StartupReady.
end)
startupStep(88,"preparing auto equip",function()
