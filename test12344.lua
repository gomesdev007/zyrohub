...
[ "gui" ]=nil;
[ "batAura" ]=false,[ "antiTrap" ]=false,[ "antiRagdoll" ]=false,[ "batAuraConnection" ]=nil,[ "antiTrapConnection" ]=nil,[ "antiRagdollConnections" ]={};
[ "alive" ]= true ,[ "plot" ]=nil;
[ "pen" ]=nil,[ "origin" ]=nil;
[ "tread" ]=nil}
local m
...
aM=function(...) h.alive=false pcall(setBatAura,false) pcall(setAntiTrap,false) pcall(setAntiRagdoll,false) pcall(function() if h.stealCounterGui then h.stealCounterGui:Destroy() end end) pcall(Ik)pcall(Ak)pcall(function() y:Set3dRenderingEnabled(true) end)pcall(D4)pcall(u4)
